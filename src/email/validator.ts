...
export class EmailValidator {
   ...
   */
  public static validateEmailData(data: unknown): EmailData {
    try {
   ...
   */
  public static validateMCPParams(data: unknown, schema: z.ZodSchema): any {
    try {
   ...
   */
  public static convertMCPParamsToEmailData(
    params: MCPEmailToolParams & { from?: string; replyTo?: string[] },
    defaults: {
   ...
   */
  public static createMCPToolSchema(config: {
    requireFrom: boolean;
    requireReplyTo: boolean;
  }): any {
    let schemaShape: any = { ...MCPEmailToolSchema.shape };
   ...
   */
  public static validateEmailAddresses(emails: string[]): boolean {
    try {
   ...
   */
  public static validateAttachment(attachment: unknown): z.infer<typeof AttachmentSchema> {
    try {
